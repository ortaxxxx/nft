        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <?php 
                    if(($network->network_slug == 'klay-testnet' && $existKlayTest == false) || ($network->network_slug == 'klay' && $existKlay == false)){ ?>
                        <div class="active_now_btn">
                            <a href="javascript:;" onclick="return confirm('Are you sure active this network?')" id="<?php echo esc($network->network_slug); ?>" class="btn btn-danger klay_network_active">Active now</a>
                        </div> 
                    <?php } ?>
                </div>
            </div>            
                    ...
                    <table class="table display table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                else if(($network->network_slug == 'klay-testnet' && $existKlayTest == true) || ($network->network_slug == 'klay' && $existKlay == true)){ ?> 
                                    <div>
...
<script src="<?php echo base_url("app/Modules/Klay_network/Assets/Admin/js/custom.js"); ?>"></script>
