                    ...
                    <table id="ajaxtable" class="table  table-bordered table-striped table-hover">
                       <thead> 
                            <tr> 
                                ...
                                <th><?php echo display('Email_Verify') ?></th> 
                                <th><?php echo display('Phone_Verify') ?></th> 
                                <th><?php echo display('Kyc_Verify') ?></th> 
                            </tr>
                        </thead>
                        <tbody>
...
<script src="<?php echo base_url("app/Modules/Kyc/Assets/Admin/js/custom.js") ?>"></script>