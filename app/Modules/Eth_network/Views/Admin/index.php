        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <?php if(($network->network_slug == 'ropsten' && $existEthTest == false) || ($network->network_slug == 'eth' && $existEth == false)){ ?>
                        <div class="active_now_btn">
                            <a href="javascript:;" onclick="return confirm('Are you sure active this network?')" id="<?php echo esc($network->network_slug); ?>" class="btn btn-danger eth_network_active">Active now</a>
                        </div> 
                    <?php } ?>
                </div>
            </div>            
                    ...
                    <table class="table display table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                else if(($network->network_slug == 'ropsten' && $existEthTest == true) || ($network->network_slug == 'eth' && $existEth == true)){ ?> 
                                    <div>
...
<script src="<?php echo base_url("app/Modules/Eth_network/Assets/Admin/js/custom.js"); ?>"></script>
