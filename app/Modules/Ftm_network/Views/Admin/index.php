        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <?php if(($network->network_slug == 'ftm-testnet' && $existEthTest == false) || ($network->network_slug == 'ftm' && $existEth == false)){ ?>
...
<script src="<?php echo base_url("app/Modules/Ftm_network/Assets/Admin/js/custom.js"); ?>"></script>
